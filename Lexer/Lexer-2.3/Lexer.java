...
public class Lexer {//espressione regolare che accetta(ma anche stringhe eraate) la sintassi degli "tag" in java e genera i token
            ...
            if (peek == '/') {
                ...
                if (peek == '*') {
                    ...
                    if (closed && peek == (char) -1) {
                        System.out.println("Il commento e' stato chiuso in maniera errata.");
                        return null;
                    }
                } else if (peek == '/') {
                    while (peek != '\n' && peek != (char) -1) {
                ...
                if (Character.isLetter(peek) || peek == '_') {
                    ...
                    if(s.compareTo("assign") == 0){
                        ...
                        return new Word(Tag.ID, s);
                            ...
                            int sum = 0;
                            //sfrutto il numero di cifre per formare il numero , ogni volta che leggo un altro nummero moltiplico per 10 per far spazio ad una nuova cifra 
                            //se e l ultima cifra prendera il posto delle unita se c'e' un altra dopo,si spostera sulle diecine quando faro x10
